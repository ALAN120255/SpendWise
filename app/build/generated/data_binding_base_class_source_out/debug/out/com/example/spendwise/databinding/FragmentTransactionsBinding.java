...
public final class FragmentTransactionsBinding implements ViewBinding {
  ...
  private FragmentTransactionsBinding(@NonNull CoordinatorLayout rootView, @NonNull Chip chipAll,
      @NonNull Chip chipExpenses, @NonNull ChipGroup chipGroupFilter, @NonNull Chip chipIncome,
  ...
  public static FragmentTransactionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTransactionsBinding((CoordinatorLayout) rootView, chipAll, chipExpenses,
          chipGroupFilter, chipIncome, etSearch, fabAdd, recyclerTransactions, tvEmpty);
    }
